<template>
    ...
    <div>
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ankeboot General Trading PLC, 4 Kilo,
                    Arada, Addis Ababa.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Ankeboot, accessible from <a href="https://www.ankeboot.com"
                        rel="external nofollow noopener" target="_blank">https://www.ankeboot.com</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: ankebootpublishing@gmail.com</li>
        </ul>
